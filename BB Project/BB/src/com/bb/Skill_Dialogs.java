...
public class Skill_Dialogs extends JPanel {
    ...
    public Skill_Dialogs(CardLayout cl, JPanel cards) {
        ...
        for (Skills s : allSkills) {
            String imagePath = s.getImage(); //get image path
    ...
    private ImageIcon Fade(ImageIcon original, float brightnessFactor) {//Dynamic Fading (Features)
