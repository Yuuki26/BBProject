...
public class OpponentPanel extends JPanel {
    ...
    public OpponentPanel() {
        ...
        statusLabel.setForeground(Color.WHITE); // Make text white

        add(bottom, BorderLayout.SOUTH);

        setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.WHITE), "Opponent Board", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, Color.WHITE));
    }
