...
public class Attacker_Skills_Instance {
    private final Attacker_Skills template;
    private int remainingUses;
    private int remainingTurns;

    public Attacker_Skills_Instance(Attacker_Skills template) {
    ...
    public Attacker_Skills getTemplate() { return template; }
